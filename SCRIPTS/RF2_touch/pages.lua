...
PageFiles[#PageFiles + 1] = { title = "Profile - PIDs",     t2 = "PIDs",                type="per_profile", script = "profile_pids.lua",      img="pids.png" }
PageFiles[#PageFiles + 1] = { title = "Profile - Various",  t2 = "Various",             type="per_profile", script = "profile_various.lua",   img="Various.png" }
...
PageFiles[#PageFiles + 1] = { title = "Rate dynamics",      t2 = "Rates adv",           type="per_profile", script = "rate_dynamics.lua" }
PageFiles[#PageFiles + 1] = { title = "PID Controller",     t2 = "PID Controller",      type="per_profile", script = "profile_pidcon.lua" }
...
if rf2.apiVersion >= 12.07 then
    ...
    -- if rf2.apiVersion >= 12.08 and settings.showXdfly == 1 then
       if rf2.apiVersion >= 12.08 then
          PageFiles[#PageFiles + 1] = { title = "ESC - XDFly",                t2 = "XDFly",   type="esc", script = "esc_xdfly.lua" }
       end
